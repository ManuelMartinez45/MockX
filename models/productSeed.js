...
module.exports = [
    ...
    {
        name: 'Dark Slate',
        description: 'With a simplified two-piece construction, the adidas Yeezy 450 Dark Slate features Dark Slate foam sole that clasps a monochromatic sock-like Primeknit upper. From there, thick rope laces add the finishing touches.',
        img: 'https://images.stockx.com/images/adidas-Yeezy-450-Dark-Slate-Product.jpg?fit=fill&bg=FFFFFF&w=700&h=500&auto=format,compress&q=90&dpr=2&trim=color&updated_at=1626801847',
        color: 'Black',
        brand: 'Yeezy',
        subtype: '450',
        price: 400,
